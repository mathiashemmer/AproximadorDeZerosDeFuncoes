...
fn main() {
    ...
    let final_bound = final_bound.parse::<f64>().expect("Non number supplied to initial bound");
    let max_iterations = max_iterations.parse::<i32>().expect("Non number supplied to initial bound");
